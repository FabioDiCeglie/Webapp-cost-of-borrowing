...
from ports.borrowing_cost_provider import BorrowingCostProvider


class EcbPortalProvider(BorrowingCostProvider):
    ...
    def _parse_observation(self, row: object) -> BorrowingCost | None:
    ...
    def fetch_observations(self) -> list[BorrowingCost]:
        ...
        observations: list[BorrowingCost] = []
        for row in payload:
